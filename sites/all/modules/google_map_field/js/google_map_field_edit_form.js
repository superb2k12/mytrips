...
//  $("#edit-token").val("lt|" + marker.getPosition().lat() + ",ln|" + marker.getPosition().lng() + ",w|" + $("#edit-width").val() + ",h|" + $("#edit-height").val() + ",z|" + google_map_field_mapTokenBuilder.getZoom());
  $("#edit-token").val("lat='" + marker.getPosition().lat() + "' lon='" + marker.getPosition().lng() + "' map_width='" + $("#edit-width").val() + "' map_height='" + $("#edit-height").val() + "' map_zoom='" + google_map_field_mapTokenBuilder.getZoom() + "'");
  return false;
}
